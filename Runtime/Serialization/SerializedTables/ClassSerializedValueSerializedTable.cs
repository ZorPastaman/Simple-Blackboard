...
{
	/// <summary>
	/// <para>Serialized table that has set keys and class values.</para>
	/// <para>Inherit this class to get this functionality.</para>
	/// </summary>
	/// <typeparam name="T">Class type of the value.</typeparam>
	public abstract class ClassSerializedValueSerializedTable<T> : SerializedValueSerializedTable_Base where T : class
	{
...
#pragma warning restore CS0649
		...
		public void SetProperty([NotNull] string key, [CanBeNull] T value, int index)
		{
			m_Keys[index] = key;
		...
		public sealed override void Apply(Blackboard blackboard)
		{
			...
			{
				blackboard.SetClassValue(new BlackboardPropertyName(m_Keys[i]), m_Values[i]);
			}
		}
