...
{
	[UsedImplicitly]
	public sealed class BoundsBlackboardValueView : BlackboardValueView<Bounds, Bounds, BoundsField>
	{
		public override BoundsField CreateBaseField(string label, VisualElement blackboardRoot = null)
		{
